        ...
        <div className="mt-12 lg:mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {steps.map((step, index) => (
              <ScrollReveal key={step.number} delay={(index % 3) + 1}>
                <div className="relative rounded-2xl border border-slate-200/80 bg-white/90 p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-sky-200 hover:shadow-lg h-full">
