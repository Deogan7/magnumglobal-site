...
const reasons = [
  {
    ...
    description:
      "Operating under Canadian trade regulations with full compliance to export standards. Consistent quality you can depend on.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Clear grading standards with detailed specifications for every shipment. Know exactly what you're receiving before it ships.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Committed to ethical textile reuse and environmental sustainability. Supporting the circular economy through responsible recycling.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Streamlined shipping to ports worldwide. Proper documentation, container loading, and customs compliance handled professionally.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "From single containers to ongoing contracts. Flexible capacity to meet your business needs as they grow.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Work directly with our team. No middlemen, no confusion. Clear communication from inquiry to delivery.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
